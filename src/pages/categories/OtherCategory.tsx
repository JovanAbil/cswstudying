            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-background rounded-lg border">
                ...
                <ol className="space-y-2 text-sm text-muted-foreground list-decimal list-inside">
                  ...
                  <li>Make sure if you want this on the website to add the teacher's name and email <p className="text-sm text-muted-foreground truncate">@abilash.jovan@charterschool.org</p></li>
                </ol>
              </div>
