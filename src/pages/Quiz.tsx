...
import { polynomialQuestions } from '@/data/polynomial-questions';
import { rationalQuestions } from '@/data/rational-questions';
import { exponentialQuestions } from '@/data/exponential-questions';
import { logarithmicQuestions } from '@/data/logarithmic-questions';
import { trigonometricQuestions } from '@/data/trigonometric-questions';
import { polarQuestions } from '@/data/polar-questions';
import { parametricQuestions } from '@/data/parametric-questions';
import { vectorsMatricesQuestions } from '@/data/vectorsMatrices-questions';
import { biochemistryQuestions } from '@/data/biochemistry-questions';
import { cellstructureQuestions } from '@/data/cellstructure-questions';
import { cellenergeticsQuestions } from '@/data/cellenergetics-questions';
import { cellgrowthQuestions } from '@/data/cellgrowth-questions';
import { geneticsQuestions } from '@/data/genetics-questions';
import { molecularQuestions } from '@/data/molecular-questions';
import { evolutionQuestions } from '@/data/evolution-questions';
import { ecologyQuestions } from '@/data/ecology-questions';
import { metricQuestions } from '@/data/metric-questions';
import { atomicQuestions } from '@/data/atomic-questions';
import { compoundsQuestions } from '@/data/compounds-questions';
import { gasesQuestions } from '@/data/gases-questions';
