...
export const logarithmicQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [{"label":"A","value":"A","text":"$\\frac{\\log(3)}{\\log(36)}$"},{"label":"B","value":"B","text":"$\\log_{2\\log(6)}(\\log(3))$"},{"label":"C","value":"C","text":"$\\log_{2\\log(3)}(\\log(6))$"},{"label":"D","value":"D","text":"$\\ln(12)$"}],
    correctAnswer: "B",
    explanation: "",
  },
  {
  ...
  },
  {
    id: "logarithmic-19",
    type: "free-response",
    question: "The functions $j$ and $k$ are given: $j(x) = \\frac{1}{2}\\ln(x) + 5\\ln(x) + \\ln(4)$ and $k(x) = \\log_{5}(\\frac{x^2}{125})$. $k(x)$ can be rewritten in the form $a + b\\log_{5}(x)$, where $a$ and $b$ are nonzero constants. Find the value of $a + b$",
    correctAnswer: "$a + b = -1$",
    explanation: "",
  },
  {
