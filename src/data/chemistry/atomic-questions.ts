...
export const atomicQuestions: Question[] = [
  ...
  },
  {
    "id": "atomic-2",
    "type": "multiple-choice",
    "question": "Why wasn’t Democritus’s idea of the atom accepted in ancient Greece?",
    "options": [
      { "label": "A", "value": "A", "text": "He didn’t publish it" },
      { "label": "B", "value": "B", "text": "It contradicted the Catholic Church" },
  ...
  },
  {
    "id": "atomic-20",
    "type": "multiple-choice",
    "question": "Which of these pairs correctly matches the scientist to their experiment?",
    "options": [
      { "label": "A", "value": "A", "text": "Thomson — Gold Foil Experiment" },
      { "label": "B", "value": "B", "text": "Rutherford — Oil Drop Experiment" },
