...
export const AdPlaceholder = ({ position, className = '' }: AdPlaceholderProps) => {
  ...
  const positionStyles = {
    // z-index set to 10 so ads are visible but pointer-events-none so they don't block
    'sidebar-left': 'fixed left-2 top-1/2 -translate-y-1/2 w-[120px] h-[600px] z-12 pointer-events-none',
    'sidebar-right': 'fixed right-2 top-1/2 -translate-y-1/2 w-[120px] h-[600px] z-12 pointer-events-none',
